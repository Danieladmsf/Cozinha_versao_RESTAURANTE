...
async function main() {
    console.log("🧹 INICIANDO VARREDURA E LIMPEZA DA TABELA CATEGORY (VIA GETDOCS) 🧹");
    ...
    try {
        ...
        console.log(`Encontrados ${snap.size} documentos usando getDocs raiz.`);
        ...
        console.error("Erro ao puxar:", err);
    }
