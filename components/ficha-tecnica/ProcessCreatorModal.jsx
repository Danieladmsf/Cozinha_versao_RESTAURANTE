...
const ProcessCreatorModalComponent = ({
  ...
  const [activeTab, setActiveTab] = useState(['receitas_-_base', 'produtos'].includes(contextType) ? 'products' : 'processes');
  ...
  useEffect(() => {
    if (isOpen) {
      console.log('[ProcessCreatorModal] contextType:', contextType, '-> activeTab:', ['receitas_-_base', 'produtos'].includes(contextType) ? 'products' : 'processes');
      setActiveTab(['receitas_-_base', 'produtos'].includes(contextType) ? 'products' : 'processes');
    }
  }, [contextType, isOpen]);
