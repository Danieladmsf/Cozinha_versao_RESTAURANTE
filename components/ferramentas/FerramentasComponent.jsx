...
export default function FerramentasComponent({ categoria }) {
    ...
    const [localData, setLocalData] = useState({
        ...
        materiais: '',
        especificacoes: '',
        custoOperacional: '', // Novo campo para equipamentos
        potencia: '',         // Novo campo para equipamentos
    ...
    const handleSelect = (ferramenta) => {
        ...
        setLocalData({
            ...
            custoOperacional: ferramenta.custoOperacional || '',
            potencia: ferramenta.potencia || '',
