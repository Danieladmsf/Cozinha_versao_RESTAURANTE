...
async function runQuery() {
    return new Promise((resolve, reject) => {
        ...
        // Final Search for 7768 in Mercafacil
        const sql = `
            SELECT 
                ...
                i.quantidade,
                i.valor_unitario
            FROM mercafacil_vendas_itens i 
            JOIN mercafacil_vendas v ON v.id_venda = i.id_venda 
            WHERE i.id_produto = 7768 
                ...
                switch (type) {
                    ...
                    case 'Z':
                        if (step === 'startup') {
                            step = 'ready';
                            if (!querySent) {
                                console.log('Executing Mercafacil Search...');
