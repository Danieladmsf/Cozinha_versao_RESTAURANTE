...
async function runQuery() {
    return new Promise((resolve, reject) => {
        ...
        // Dump recent sales from venda
        const sql = "SELECT * FROM venda WHERE data >= '2026-02-01' LIMIT 500";
                ...
                switch (type) {
                    ...
                    case 'Z':
                        if (step === 'startup') {
                            step = 'ready';
                            if (!querySent) {
                                console.log('Executing Venda Dump...');
                            ...
                            const dumpFile = path.join(__dirname, 'dados_extraidos', 'venda_dump.json');
