...
async function runQuery() {
    return new Promise((resolve, reject) => {
        ...
        // Query to match screenshot
        // Screenshot shows: 7337 (0.240), 7660 (4), 8966 (12), 7768 (3), 8321 (4)
        // Table `venda` probably has time or data__emissao
        ...
        const sql = `
            ...
            LEFT JOIN produto p ON p.id = vi.produto
            WHERE v.data__emissao = '2026-02-02' 
            AND vi.produto IN (7337, 7660, 8966, 7768, 8321)
