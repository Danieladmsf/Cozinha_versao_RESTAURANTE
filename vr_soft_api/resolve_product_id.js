...
async function runQuery() {
    return new Promise((resolve, reject) => {
        ...
        // Check product 7768
        const sql = "SELECT id, descricaocompleta, codigobarras FROM produto WHERE id = 7768 OR codigobarras = '7768' OR codigobarras = '007768'";
                ...
                switch (type) {
                    ...
                    case 'Z':
                        if (step === 'startup') {
                            step = 'ready';
                            if (!querySent) {
                                console.log('Executing Product Lookup...');
